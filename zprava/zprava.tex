...
\begin{document}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{|c|c|}
            \hline
            \multicolumn{1}{|l|}{\textbf{instance}} & \multicolumn{1}{l|}{\textbf{{}doba běhu} {[}minuty{]}} \\ \hline
            saj7                           & 1.727                                       \\ \hline
            saj10                          & 8.163                                       \\ \hline
            saj12                          & 4.542                                       \\ \hline
        \end{tabular}
        \caption{Sekvenční algoritmus.}
        \label{tab:seq}
    \end{table}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{|c|c|l|}
            \hline
            \multicolumn{1}{|l|}{\textbf{instance}} & \multicolumn{1}{l|}{\textbf{\#jader}} & \textbf{doba běhu} {[}minuty{]} \\ \hline
            ...
            & 20 & 5.654 \\ \hline
        \end{tabular}
        \caption{OpenMP task algoritmus.}
...
% \usepackage{multirow}
    \begin{table}[]
        ...
        \begin{tabular}{|c|c|l|}
            ...
            & 20 & 8.986 \\ \hline
        \end{tabular}
        \caption{OpenMP data algoritmus.}
